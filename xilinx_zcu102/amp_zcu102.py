...
class BaseSoC(SoCMini):
    ...
    def __init__(self, platform, platform_name, toolchain="vivado",
                 sys_clk_freq=int(125e6), with_led_chaser=True):
        ...
        os.system("litex_soc_gen --cpu-type=femtorv --bus-standard=wishbone "
                  "--sys-clk-freq=125e6 --name=femtorv_soc --integrated-main-ram-size=0x8000 --build")
...
def main():
    ...
    parser = LiteXSoCArgumentParser(description="LiteX standalone SoC generator on ZCU102")
    target_group = parser.add_argument_group(title="Target options")
    target_group.add_argument("--platform", default=xilinx_zcu102.Platform())
